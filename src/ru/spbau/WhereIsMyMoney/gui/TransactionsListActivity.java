...
//    }
//    
//    private String fullDesription(Transaction trans) {
//    	StringBuilder sb = new StringBuilder();
//    	sb.append(FORMATTER.format(trans.getDate())).append("\n");
//    	sb.append("Balance: ").append(trans.getBalance()).append("\n");
//    	sb.append("Card: ").append(trans.getCard()).append("\n");
//    	if (trans.getDelta() != null) {
//    		sb.append("Delta: ").append(trans.getDelta()).append("\n");
//    	}
//    	if (trans.getPlace() != null) {
//    		sb.append("Place: ").append(trans.getPlace()).append("\n");
//    	}
//    	return sb.toString();
//    }
...
//        ArrayAdapter<Transaction> adapter = new TransactionListAdapter(context, transactions);
        ...
        //    messages[i] = fullDesription(trans);
        //}
...
//    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String card = intent.getStringExtra(ID_PARAM);
...
//        createListView(message);
        ListView listView = (ListView) findViewById(ru.spbau.WhereIsMyMoney.R.id.transactions);
        List<Transaction> transactions = db.getTransactionsPerCard(card);
