...
public class CostsReportSetupActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ru.spbau.WhereIsMyMoney2.R.layout.costs_report_setup);

        final DatePicker startDate = (DatePicker) findViewById(ru.spbau.WhereIsMyMoney2.R.id.startDate);
        final DatePicker endDate = (DatePicker) findViewById(ru.spbau.WhereIsMyMoney2.R.id.endDate);
